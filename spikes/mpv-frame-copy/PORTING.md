...
- **UPDATE 2026-07-12: the Windows port below is DONE** (branch
  `claude/windows-frame-copy-port-7ff4b9`, stacked on the Linux port
  branch) — WGL GlContext twin, QPC clock + `Local\` named-file-mapping
